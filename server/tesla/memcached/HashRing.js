/**
 * @class tesla.memcached.HashRing
 * @extends Object
...
include('tesla/memcached/Bisection.js');
 ...
 * Module dependencies
 */
var CreateHash = tesla.node.crypto.createHash;
var StringDecoder = tesla.node.string_decoder.StringDecoder;
var Bisection = tesla.memcached.Bisection;
...
Class('tesla.memcached.HashRing', {
  ...
  replace: function(oldKey, newKey) {
    ...
    // replace the servers
    tesla.keys(this.ring).forEach(function(key) {
    ...
    tesla.keys(this.cache).forEach(function(key) {
